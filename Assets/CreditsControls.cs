        ...
        if (mobile == false)
        {
            foreach (ControllerInput controller in FindObjectsOfType<ControllerInput>())
            {
                if (hasFocus && controller.leftStick.y < -0.5 && canDo)
                {
                    if (index != 7)
                    {
                        if (index != -1)
                        {
                            ...
                            if (index == 4)
                                slider3.GetComponent<PauseButtons>().Unhighlight();
                            if (index == 5)
                                slider4.GetComponent<PauseButtons>().Unhighlight();
                            if (index == 6)
                        ...
                        if (index == 4)
                            slider3.GetComponent<PauseButtons>().Highlight();
                        if (index == 5)
                            slider4.GetComponent<PauseButtons>().Highlight();
                        if (index == 6)
                ...
                if (index == 4 || index == 5)
                {
                    ...
                    {
                        if (index == 4)
                            slider3.GetComponent<PauseButtons>().MoreVolume();
                        else slider4.GetComponent<PauseButtons>().MoreVolume();
                    ...
                    {
                        if (index == 4)
                            slider3.GetComponent<PauseButtons>().LessVolume();
                        else slider4.GetComponent<PauseButtons>().LessVolume();
