...
namespace TMPro.Examples
{
    ...
    public class ShaderPropAnimator : MonoBehaviour
    {
        ...
        IEnumerator AnimateProperties()
        {
            ...
            while (true)
            {
                //lightAngle = (m_Material.GetFloat(ShaderPropertyIDs.ID_LightAngle) + PublicVariables.deltaTime) % 6.2831853f;
                ...
                m_frame += PublicVariables.deltaTime * Random.Range(0.2f, 0.3f);
